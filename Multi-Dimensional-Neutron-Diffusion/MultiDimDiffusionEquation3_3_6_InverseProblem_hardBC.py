...
# 定义数据
data = dde.data.TimePDE(geomtime, pde, [ic, observe_y], num_domain=300, num_boundary=200, num_initial=100,
                        solution=None,
...
# 定义求解器
model.compile("adam", lr=0.001, loss_weights=[1, Pi, Pc], external_trainable_variables=[k_eff])
